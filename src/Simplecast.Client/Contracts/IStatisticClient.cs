...
namespace Simplecast.Client.Contracts
{
    public interface IStatisticClient
    {
        ...
        Task<ApiResponse<Statistic>> GetPodcastStatisticOverallResponseAsync(
            int podcastId, OverallStatisticFilter overallStatisticFilter = null);

        Task<ApiResponse<Statistic>> GetEpisodeStatisticResponseAsync(int podcastId,
                                                                      EpisodeStatisticFilter episodeStatisticFilter);

        Task<Statistic> GetPodcastStatisticAsync(int podcastId);

        Task<Statistic> GetPodcastStatisticOverallAsync(int podcastId,
