...
namespace Simplecast.Client.Clients
{
    public class EpisodeClient : IEpisodeClient
    {
        ...
        {
            var apiResponse = await _restApiClient.GetApiResponseAsync<List<Episode>>(UrlPathBuilder.GetEpisodesUrl(podcastId));
        ...
        {
            var apiResponse = await _restApiClient.GetApiResponseAsync<Episode>(UrlPathBuilder.GetEpisodeByIdUrl(podcastId, episodeId));
        ...
        {
            var apiResponse = await GetEpisodesResponseAsync(podcastId);
        ...
        {
            var apiResponse = await GetEpisodeByIdResponseAsync(podcastId, episodeId);
